...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// NÃO FOI NECESSÁRIA A CRIAÇÃO DE UM REPOSITÓRIO EXCLUSIVO DEVIDO A ASSOCIAÇÃO UM PARA UM. COM ISSO PODEMOS 'REAPROVEITAR' O REPOSITÓRIO DA CLASSE A QUAL ESSA ESTÁ ASSOCIADA
		o1.setPayment(pay1);
